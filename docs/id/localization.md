[English](../localization.md) · **Bahasa Indonesia**
...
## Konvensi bahasa dokumentasi

English juga menjadi bahasa kanonis dokumentasi. `README.md`, seluruh panduan
tingkat atas dalam `docs/`, dan `packaging/README.md` harus ditulis dalam
English serta secara default menautkan panduan English lainnya. Pasangan Bahasa
Indonesia yang dipelihara berada di `README.id.md`, `docs/id/<name>.md`, dan
`packaging/README.id.md`. Tautan pengalih bahasa di bagian atas dokumen adalah
satu-satunya tautan dari halaman kanonis yang boleh masuk ke pohon dokumentasi
Bahasa Indonesia.

Buat atau perbarui dokumen English terlebih dahulu, kemudian terapkan perubahan
fakta dan keselamatan yang sama pada pasangan Bahasa Indonesianya. Jangan ubah
baris perintah, path, token konfirmasi, atau identifier protokol. Pemberitahuan
hukum yang mereproduksi ketentuan pihak ketiga tetap memakai bentuk English
aslinya. Screenshot pratinjau README harus menampilkan GUI dalam locale English
default.
